...
source_ids:
  ...
  - hrl-about
evidence_chart:
  kicker: Pre-transaction baseline
  title: HRL publicly describes four laboratories and five centers
  summary: The organizational counts establish a documented baseline for later comparison. They do not measure headcount, quality, autonomy, adjacency, or the capability that will survive a transaction.
  aria_label: HRL’s public profile describes four laboratories and five centers before the announced IBM transaction.
  source_id: hrl-about
  note: Counts of named organizational units, not a capability score. A center and a laboratory are not assumed to be equivalent in size, funding, or function.
  bars:
    - { label: "Laboratories", value: "4 named units", percent: 80, tone: blue }
    - { label: "Centers", value: "5 named units", percent: 100, tone: green }
argument_map:

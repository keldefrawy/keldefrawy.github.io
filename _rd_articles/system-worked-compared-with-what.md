---
title: The System Worked. Compared With What?
article_number: 18
article_slug: system-worked-compared-with-what
permalink: /rd-ratchet/system-worked-compared-with-what/
article_status: Draft
published: true
dek: The transistor, modern computing, the Internet, software, cryptography, smartphones, AI, and quantum technology are real achievements. They prove that the R&D system can produce extraordinary outcomes—not that it produced them at acceptable cost, speed, or institutional loss.
date: 2026-07-26
updated: 2026-07-26
version: "0.1"
version_sequence: 1
revision_summary: Initial public working manuscript separating achievement, efficiency, public value, capability renewal, and institutional sustainability.
reading_time: 23
central_claim: A catalogue of breakthroughs establishes productive capacity, not counterfactual efficiency or institutional sustainability; the next R&D system should be judged by whether it produces verified and transitioned results while replenishing the people, teams, tools, and pathways that make the next generation possible.
claim_status: Provisional measurement framework; 2×, 10×, and 4–5× acceleration are testable targets, not findings asserted by this draft
hero_image: /assets/images/rd-ratchet/articles/article-18-system-worked.webp
hero_alt: A bright gallery of the transistor, stored-program computer, Internet network, compiler, cryptographic keys, smartphone, AI accelerator, and quantum device feeds into two contrasting instruments, while fading laboratory buildings reveal the separate question of institutional renewal.
hero_caption: Conceptual argument illustration. The technologies emerged from different institutions, countries, decades, and funding regimes; the image does not assign any one organization sole credit.
source_ids:
  - ncses-rd-2026
  - nsf-innovation-measurement-2018
  - nobel-transistor-1956
  - turing-computable-numbers
  - von-neumann-edvac
  - ias-computer-project
  - shannon-communication
  - darpa-arpanet
  - acm-turing-fact-sheet
  - acm-diffie-hellman-2015
  - apple-iphone-2007
  - acm-deep-learning-2018
  ...
  - jones-williams-social-return
  - gao-grant-burden
evidence_chart:
  kicker: Success beside effort
  title: Moore’s Law continued while measured research effort rose
  summary: Bloom and coauthors estimate that sustaining the familiar doubling of chip density required more than eighteen times as many researchers as in the early 1970s. The result is a domain-specific estimate under an exponential-growth benchmark, not a verdict on all semiconductor research or U.S. R&D.
  aria_label: In the authors' Moore's Law analysis, early-1970s research effort is normalized to one, while later effort required to sustain the doubling rate is reported as more than eighteen times that baseline.
  source_id: bloom-idea-productivity
  note: Normalized research effort, not dollars or transistor counts. The estimate can coexist with enormous technical and social value.
  bars:
    - { label: "Early 1970s baseline", value: "1× effort", percent: 5.6, tone: blue }
    - { label: "Later measured effort", value: ">18× effort", percent: 100, tone: amber }
argument_map:
  kicker: Source-linked argument map
  title: Achievement is one numerator; a system has several denominators
  summary: The historical record defeats the claim that the ecosystem produced nothing. It does not identify the attainable frontier or show that the institutions producing the gains were replenished.
  caption: The map separates outcomes that public debate often collapses. Institutional survival is not intrinsically good; preservation matters when valuable capability cannot be transferred or rebuilt at lower cost.
  nodes:
    - role: Strongest defense
      title: The achievements are real
      text: Transistors, general computation, communication theory, the Internet, high-level languages, UNIX, public-key cryptography, smartphones, deep learning, and quantum-computing concepts form an extraordinary record.
      source_ids: [nobel-transistor-1956, turing-computable-numbers, shannon-communication, darpa-arpanet, acm-turing-fact-sheet, acm-diffie-hellman-2015, apple-iphone-2007, acm-deep-learning-2018, feynman-quantum-simulation]
    - role: Attribution boundary
      title: There was never one system
      text: The record combines corporate laboratories, universities, wartime and mission programs, public infrastructure, standards communities, startups, manufacturers, and international contributors across generations.
      source_ids: [ias-computer-project, darpa-arpanet, nsf-innovation-measurement-2018]
    - role: Sustainability test
      title: Breakthrough success did not guarantee renewal
      text: Bell Labs changed parents and form, PARC joined SRI, and IBM announced an agreement to acquire HRL that remained pending when this draft was written.
      source_ids: [nokia-bell-history, xerox-parc-sri, hrl-about, ibm-hrl-2026]
    - role: Counterfactual gap
      title: High value can coexist with low measured productivity
      text: Estimated social returns can support more R&D even while domain studies find rising effort per unit of exponential progress. More investment and better organization are different hypotheses.
      source_ids: [jones-williams-social-return, bloom-idea-productivity]
    - role: Bounded conclusion
      title: Test the attainable frontier
      text: Compare matched portfolios on verified learning, transition, calendar time, total labor, administrative load, capability residue, and later correction—not on output counts alone.
      source_ids: [nsf-innovation-measurement-2018, gao-grant-burden]
objection_ladders:
  - claim: A record of transformative inventions does not establish that the R&D system is efficient.
    first_objection: The counterfactual is unknowable. We cannot rerun the twentieth century with a different Bell Labs, ARPA, university system, or industrial structure.
    first_response: >-
      A unique historical optimum is indeed unidentified. The useful claim is narrower: achievement alone cannot identify it, and present institutions can run prospective, matched portfolio comparisons with predeclared outcomes and common accounting.
    second_objection: Once funding depends on measured speed or efficiency, researchers will select legible, incremental problems and underinvest in foundational work whose value arrives decades later.
    conclusion: Use a multidimensional frontier rather than one score, preserve an explicitly exploratory portfolio, and measure long-horizon capability and option creation beside near-term verification and transition.
    source_ids: [nsf-innovation-measurement-2018, bloom-idea-productivity]
  - claim: The loss or absorption of famous laboratories is evidence that the ecosystem failed to sustain important research capability.
    first_objection: Institutions are not sacred. Successful knowledge diffuses, technologies mature, firms change, and keeping every historic laboratory alive would freeze capital and talent in obsolete forms.
    first_response: Correct. Name survival is not the objective. The question is whether valuable teams, instruments, memory, apprenticeship, problem-selection authority, and transition relationships were deliberately renewed, transferred, or allowed to vanish without accounting.
    second_objection: >-
      A laboratory may disappear precisely because it succeeded: its ideas became infrastructure, its people dispersed productively, and specialized successors outperformed the integrated parent.
    conclusion: Count successful diffusion as a gain, but subtract reconstruction cost, lost adjacencies, abandoned options, and the inability to reproduce the developmental pathway. Dissolution is not failure when capability transfers or becomes cheaper to rebuild; it is failure when the system consumes a scarce stock without replacing it.
    source_ids: [nokia-bell-history, nasem-telecom-research-2006, xerox-parc-sri, arora-corporate-science]
corrections: []
---
...
1. How much total resource did each outcome require?
2. How long did society wait relative to an attainable alternative?
3. Which capabilities survived to produce the next outcome?
4. Could the same resources have produced two times—or ten times—the verified public value, or the same value four to five times faster?
...
The [1956 Nobel Prize in Physics](#source-nobel-transistor-1956) recognized John Bardeen, Walter Brattain, and William Shockley for semiconductor research and discovery of the transistor effect. Bardeen’s Nobel lecture described a Bell Telephone Laboratories program combining theory, surface physics, materials, chemistry, instrumentation, and circuit expertise. The transistor was not one isolated flash; it was an integrated research capability making a sequence of theory and experiment possible. <span class="rd-evidence-token" data-evidence="D">D</span>

[Turing’s 1936 paper](#source-turing-computable-numbers) supplied a general model of mechanical computation while proving a limit on what such procedures can decide. [The EDVAC report](#source-von-neumann-edvac) and the [Institute for Advanced Study computer project](#source-ias-computer-project) show a different layer: architecture, engineering, public support, construction, operation, open reporting, and replication. “The computer” was neither a theorem alone nor a machine alone. <span class="rd-evidence-token" data-evidence="D">D</span>

[Shannon’s 1948 theory](#source-shannon-communication) separated source, channel, noise, coding, and receiver in a way that still structures digital communication. [DARPA’s ARPANET history](#source-darpa-arpanet) records a four-node network in 1969 that included Stanford Research Institute, followed by internetworking work, TCP/IP, academic expansion, and commercialization. The Internet was not the product of a single laboratory or funding instrument. It accumulated through public programs, universities, nonprofit and corporate research, standards, network operators, equipment makers, and international adoption. <span class="rd-evidence-token" data-evidence="D">D</span>

The [ACM Turing Award record](#source-acm-turing-fact-sheet) recognizes John Backus for FORTRAN and practical high-level programming systems, and Ken Thompson and Dennis Ritchie for operating-systems theory and UNIX. The [Diffie–Hellman award record](#source-acm-diffie-hellman-2015) identifies public-key cryptography and digital signatures as foundations of modern secure communication. These are not secondary decorations around hardware. Languages, compilers, operating systems, algorithms, and cryptography changed who could use computation and what society could safely do with it. <span class="rd-evidence-token" data-evidence="D">D</span>

[Apple’s original iPhone announcement](#source-apple-iphone-2007) describes an integration of telephony, Internet communication, software, sensors, and multi-touch interaction. It is a company’s product announcement, not a neutral history and not evidence that Apple invented every component. Its importance here is architectural: public and private research became a coherent product only after extraordinary systems engineering, supply chains, manufacturing, networks, software, design, and capital converged. <span class="rd-evidence-token" data-evidence="D">D</span>

The [2018 Turing Award record](#source-acm-deep-learning-2018) credits Yoshua Bengio, Geoffrey Hinton, and Yann LeCun for conceptual and engineering advances that made deep neural networks central to computing. Long before current quantum roadmaps, [Feynman’s 1982 paper](#source-feynman-quantum-simulation) asked whether a machine governed by quantum mechanics was the appropriate instrument for simulating a quantum world. AI and quantum technology each combine decades of theory, algorithms, fabrication, instruments, data, compute, public funding, corporate investment, and international work. <span class="rd-evidence-token" data-evidence="D">D</span>
...
The [National Science Board’s innovation framework](#source-nsf-innovation-measurement-2018) explicitly distinguishes discovery, invention, knowledge transfer, and innovation and warns that available inputs and outputs provide an incomplete picture of impact. A transistor effect, a manufacturable semiconductor process, a computer architecture, an operating system, a network standard, and a mass-market smartphone occupy different positions in that chain. <span class="rd-evidence-token" data-evidence="D">D</span>
...
Classical Bell Labs was not an independent company selling pure research. It was embedded in a communications, equipment, manufacturing, and regulatory settlement that paid for a broad laboratory. The [current Nokia Bell Labs history](#source-nokia-bell-history) accurately preserves a remarkable lineage and documents later transitions through Lucent, Alcatel-Lucent, and Nokia. AT&T Labs preserves another branch. Neither fact means the original institutional settlement survived. <span class="rd-evidence-token" data-evidence="D">D</span>

The [National Academies’ telecommunications study](#source-nasem-telecom-research-2006) found that the post-1996 Bell-family research system split and contracted while long-term fundamental telecommunications research became less stable. That does not prove every smaller successor was worse. It shows that historical output cannot substitute for an account of what was renewed after the split. <span class="rd-evidence-token" data-evidence="D">D</span>

[Xerox announced in 2023](#source-xerox-parc-sri) that PARC would be donated to SRI International. PARC’s ideas influenced personal computing far beyond the value captured by Xerox, but public impact does not by itself finance the next PARC. The transfer may preserve people and capability better than closure would have; it also establishes that PARC no longer stood under its prior institutional arrangement. <span class="rd-evidence-token" data-evidence="D">D</span>

[HRL describes](#source-hrl-about) an institution jointly owned by Boeing and General Motors, combining owner R&D with government and commercial work. On July 23, 2026, [IBM announced an agreement to acquire HRL](#source-ibm-hrl-2026), subject to closing conditions. This draft makes no post-transaction claim and does not say HRL has already ceased to exist as a separate entity. The announcement nevertheless makes sustainability a live measurement question: which capabilities, teams, sponsor relationships, and degrees of problem-selection authority would expand, transfer, narrow, or disappear if the transaction closes? <span class="rd-evidence-token" data-evidence="D">D</span>
...
[NCSES estimates](#source-ncses-rd-2026) that the United States is approaching a trillion dollars in annual R&D expenditure. That total measures activity. It does not supply a complete cost per consequential, verified, transitioned outcome. <span class="rd-evidence-token" data-evidence="D">D</span>
...
1. the uncertainty or capability sought;
2. problem difficulty, dependencies, and acceptable evidence;
3. dollars, technical labor, compute, facilities, and administrative labor;
4. the expected path to independent verification and use;
5. capabilities expected to remain even if the focal hypothesis fails; and
6. one-, three-, five-, and ten-year outcome measures.
...
The [documented decline in scientific publication by large corporate R&D performers](#source-arora-corporate-science) does not by itself prove a national loss—firms may perform proprietary science, acquire knowledge, or shift toward development. It does show that one historical channel changed substantially. The burden is to identify what replaced its open knowledge, internal adjacencies, and training function rather than pointing to the national output total. <span class="rd-evidence-token" data-evidence="D">D</span>

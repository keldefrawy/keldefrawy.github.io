---
title: An AI-Native Laboratory for the Public Good
article_number: 17
article_slug: ai-native-public-good
permalink: /rd-ratchet/ai-native-public-good/
...
reading_time: 18
central_claim: A viable successor must align patient capital, technical careers, shared infrastructure, independent correction, transition responsibility, and public-value rights in one institution; adding AI to today’s fragmented incentives will only accelerate their failures.
...
evidence_chart:
  ...
  summary: The data show that the United States already funds durable government-linked R&D institutions at scale. Spending growth does not establish that every center preserves exploratory research, independent judgment, or transition capability.
  aria_label: Federally funded research and development center expenditures rose from 17.7 billion dollars in fiscal year 2014 to 31.7 billion dollars in fiscal year 2024.
  source_id: ncses-ffrdc-2024
  note: Current dollars; the 2024 increase partly reflects a reporting-methodology change at Idaho National Laboratory. Expenditure is not a capability score.
  bars:
    - { label: "FY 2014", value: "$17.7B", percent: 55.8, tone: blue }
    - { label: "FY 2024", value: "$31.7B", percent: 100, tone: green }
argument_map:
  kicker: Source-linked argument map
  title: The successor is a governance and incentive system, not a model with a building
  summary: Current programs demonstrate components; none alone supplies the complete institutional stack.
  caption: The proposal should be rejected or redesigned if a pilot cannot outperform existing arrangements on capability formation, correction, transition, and public value.
  nodes:
    - role: Documented observation
      title: The building blocks already exist
      text: FFRDCs provide durable sponsor relationships, DARPA provides empowered program leadership, NAIRR provides shared AI resources, NSTC provides a public–private prototyping model, and DOE funds transition partnerships.
      source_ids: [far-ffrdc, darpa-pm-model, nairr-2026, nstc, doe-tcf]
    - role: Measurement gap
      title: No component owns the whole path
      text: Shared compute, programs, universities, centers, and commercialization mechanisms remain governed by different clocks and success measures.
      source_ids: [ncses-rd-2026, gao-dhs-ffrdc-2025]
    - role: Design mechanism
      title: Align six durable layers
      text: Institutional memory, scientific agents, secure resources, physical testbeds, apprenticeship, and transition must share a mission and capability balance sheet.
      source_ids: [nairr-2026, nstc, gao-ffrdc]
    - role: Bounded conclusion
      title: Run a falsifiable ten-year pilot
      text: Start with a few mission areas, independent governance, staged capital, competing technical paths, public-interest rights, and predeclared failure criteria.
      source_ids: [nasem-arpa-e-2017, doe-tcf]
objection_ladders:
  - claim: A federally anchored public–private laboratory can preserve research capability better than the fragmented system.
    first_objection: Such an institution will be captured by incumbent firms, political priorities, security bureaucracy, or permanent internal constituencies.
    first_response: Those are central design risks. Funding diversity, fixed governance terms, conflicts rules, transparent portfolios, protected dissent, external replication, and periodic mission reauthorization are required.
    second_objection: The safeguards themselves create administrative load and may select safe, legible work instead of frontier research.
    conclusion: Separate fiduciary controls from technical micromanagement, apply reporting proportionally to risk, and judge the pilot by whether technical teams retain time and authority for uncertain work.
    source_ids: [gao-ffrdc, nasem-arpa-e-2017, gao-dhs-ffrdc-2025]
  - claim: AI-native infrastructure can extend institutional memory and accelerate science.
    first_objection: Centralized models, data, and compute can amplify common-mode errors, surveillance, vendor dependence, and concentration of scientific authority.
    first_response: Yes. The architecture needs provenance, model diversity, reproducible environments, privacy-preserving access, independent red teams, and portable artifacts.
    second_objection: Those controls do not solve who sets public priorities or bears responsibility when an AI-assisted result causes harm.
    conclusion: AI receives no governing authority or legal accountability. Named humans and chartered bodies own priorities, risk acceptance, correction, and deployment decisions.
...
[DARPA’s program-manager model](#source-darpa-pm-model) demonstrates empowered, fixed-term technical leadership. [The National Academies’ ARPA-E assessment](#source-nasem-arpa-e-2017) demonstrates a related active-management model. The successor should borrow authority and urgency without becoming another temporary network.

[NAIRR](#source-nairr-2026) demonstrates shared public–private access to compute, data, models, tools, and training. At its two-year mark NSF reported more than 600 research teams and 6,000 students across every state, the District of Columbia, and Puerto Rico. [NSTC](#source-nstc) is designed as a public–private semiconductor consortium spanning research, prototyping, investment, and workforce. [DOE’s Technology Commercialization Fund](#source-doe-tcf) demonstrates cost-shared lab-to-market partnership. Each solves part of the graph. None owns the whole path from uncertain question to retained public capability. <span class="rd-evidence-token" data-evidence="D">D</span>
